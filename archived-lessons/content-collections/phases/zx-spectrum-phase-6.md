...
system: "zx-spectrum"
phase_number: 6
description: "Build reusable game engines and development frameworks for the ZX Spectrum. Create sophisticated systems for sprite management, collision detection, audio mixing, and memory management."
learning_objectives:
  - "Design and implement reusable Spectrum game engine architecture"
  - "Create sophisticated sprite and collision systems within memory constraints"
  - "Build professional audio mixing for AY and beeper systems"
  - "Develop efficient memory management and resource frameworks"
  - "Apply professional game development workflow adapted for Spectrum"
prerequisites:
  - "Completion of Phase 5: System Programming & Utilities"
  - "Comfortable with system-level Spectrum programming"
...
tools_required:
  ...
  - "Memory optimization and analysis systems"
  - "Cross-development and asset management tools"
order: 6
---
