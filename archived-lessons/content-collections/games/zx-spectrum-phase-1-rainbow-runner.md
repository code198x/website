...
description: "A colorful platform game that embraces the Spectrum's unique colour system, teaching Z80 assembly programming through sprite movement, collision detection, and sound programming."
gameplay_mechanics:
  - "Navigate through colour-coded platform levels"
  ...
  - "Power-ups that change colour properties"
technical_features:
  ...
  - "Smooth scrolling using optimised Z80 routines"
concepts_demonstrated:
  ...
  - "Game feel and responsive controls through optimised assembly"
...
Run and jump through levels where colour boundaries matter:
...
- **Rainbow Collection**: Gather colour fragments to unlock new areas
...
- **Performance**: Achieving smooth movement through optimised Z80 code
