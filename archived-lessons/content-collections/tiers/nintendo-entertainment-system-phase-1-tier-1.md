---
title: "Circuit Surge: Digital Circuit Adventure"
system: "nintendo-entertainment-system"
phase_number: 1
tier_number: 1
description: "Create your first complete console game! Build 'Circuit Surge' - an electrical current flow game using authentic 6502 assembly. Learn assembly language through exciting game development that showcases the NES's precise control and distinctive aesthetic."
learning_objectives:
  - "Create digital circuit worlds using NES graphics hardware precision"
  - "Build electrical current conductors using 6502 registers for flow control"
  - "Master NES memory-mapped I/O through direct circuit visualization"
  - "Implement electrical current physics through assembly logic programming"
  - "Develop complete console games with authentic NES precision and timing"
concepts_introduced:
  - "6502 registers through electrical current conductor management"
  - "NES PPU programming for digital circuit visualization"
  - "Memory-mapped I/O for precise console-level control"
  - "Electrical simulation logic and current flow algorithms"
  - "Console game timing and responsive control systems"
...
**By Lesson 8**: You'll have a playable game prototype with graphics, current flow, and basic electrical systems!
**By Lesson 32**: You'll have the foundation systems for Circuit Surge, ready for advanced development in Tiers 2-4.
**By Tier 4 Complete**: You'll have a sophisticated electrical simulation game showcasing advanced 6502 programming and NES precision.
