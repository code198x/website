...
dfs_high_done:
            ...
            ; Convert and draw high score digits
...
cnr_loop:
            ...
            jsr silence_all
            jsr check_high_score    ; Check for new high score (Unit 14)
            lda #STATE_VICTORY
            sta game_state
...
; Draws "PAUSED" in center of screen
;───────────────────────────────────────
PAUSE_ROW   = 11
PAUSE_COL   = 17
...
;───────────────────────────────────────
; Check and update high score (Unit 14)
...
key_c_was:      !byte $00
key_v_was:      !byte $00
key_p_was:      !byte $00           ; Unit 15: Pause key state
