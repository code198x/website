...
const sanitizeMetricData = (data: any): { name: string; value: number; timestamp: number } | null => {
...
describe('Performance Helper Functions', () => {
  ...
  describe('Integration Tests', () => {
    ...
    it('should handle batch processing of metrics', () => {
      ...
      const sanitizedMetrics = rawMetrics
        .map(sanitizeMetricData)
        .filter(Boolean) as Array<{ name: string; value: number; timestamp: number }>;
