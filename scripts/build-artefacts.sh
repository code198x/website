...
# docs/website.md#code-and-artefacts in the Code198x
...
# From the unit folder: a Spectrum tape's header carries the output path as
# its name, which the machine prints while loading ("Bytes: border.tap").
(cd "$SAMPLES/sinclair-zx-spectrum/assembly/meet-the-machine/unit-01" && asm198x --dialect pasmo --cpu z80 --tapbas border.asm -o border.tap)
