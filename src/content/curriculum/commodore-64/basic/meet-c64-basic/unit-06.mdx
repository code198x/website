...
description: "Let the program decide. IF tests a condition; THEN runs the rest of the line only when it holds. The C64 has no ELSE — so two-way choices are simply two IFs, one per outcome."
pubDate: 2026-06-07
game: 0
unit: 6
