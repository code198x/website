...
<Figure
  src="/images/commodore-64/assembly/meet-the-machine/unit-11/screenshot.png"
  alt="Two short red bars of blocks, one on the top row and one on the row below."
  caption="Two bars from one subroutine: the bar-drawing code written once and called twice, each with a different starting cell."
/>
