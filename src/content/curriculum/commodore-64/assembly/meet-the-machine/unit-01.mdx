...
> **New to programming entirely?** You'll have a smoother time meeting the fundamentals in our [BASIC course](/sinclair-zx-spectrum/basic) first — this track assumes you've already met variables, loops and subroutines somewhere. If you have, in any language, you're in the right place.
...
![The C64's empty screen surrounded by a solid red border.](/images/commodore-64/assembly/meet-the-machine/unit-01/screenshot.png)
