...
<Figure
  src="/images/commodore-64/assembly/meet-the-machine/unit-02/screenshot.png"
  alt="The C64's screen surrounded by a solid green border."
  caption="A green border — but the real show is in the registers: the 5 travelled from A into X, survived A being wiped, and came back."
/>
