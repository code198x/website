...
<Figure
  src="/images/commodore-64/assembly/meet-the-machine/unit-07/screenshot.png"
  alt="The C64's screen surrounded by a solid green border."
  caption="Green because the program decided: it compared a number with 5, matched, and branched to the road that sets green."
/>
