...
<Figure
  src="/images/commodore-64/assembly/meet-the-machine/unit-03/screenshot.png"
  alt="The C64's screen surrounded by a solid white border."
  caption="A white border set by storing the letter 'A' — which the machine reads as 65, its low bits landing on white. A letter was a number all along."
/>
