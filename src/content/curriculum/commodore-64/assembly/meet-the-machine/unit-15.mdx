...
<Figure
  ...
  alt="Several rows of solid red blocks filling the top of the C64 screen, far more than one."
  caption="Six-and-a-bit rows, not one — the machine filled exactly 255 cells because 255 is the number we wrote; a 'mistake' only because we meant 40."
/>
