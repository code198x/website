...
![A single solid white block in the top-left corner of the C64's screen.](/images/commodore-64/assembly/meet-the-machine/unit-05/screenshot.png)
...
- **A character appears but you can't see it.** It's drawn in the cell's colour, and if that colour matches the background it hides. We take charge of cell colour in the very next unit.
