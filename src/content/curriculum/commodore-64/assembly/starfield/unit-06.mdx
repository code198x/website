...
- **A different threat colour.** `$d029` takes any C64 colour: `$02` red, `$07` yellow, `$0e` light blue. Pick one that reads clearly against black without competing with the white ship.
...
The enemy comes at you and your bullet flies past it — they don't notice each other yet. Next you'll add collision detection, so a shot that meets the enemy actually destroys it.
