...
<CodeFromFile src="nintendo-entertainment-system/assembly/dash/unit-05/snippets/01-jump-sound.asm" />
...
The sound only triggers when the player actually jumps — both A pressed and on the ground. If the player is mid-air, the `BEQ @no_jump` skips the entire block, including the sound. One jump, one chirp. Here's how it sounds:

<audio controls src="/images/nintendo-entertainment-system/assembly/dash/unit-05/jump.wav"></audio>

## The Complete Code

<CodeFromFile src="nintendo-entertainment-system/assembly/dash/unit-05/dash.asm" />

![Dash Unit 5](/images/nintendo-entertainment-system/assembly/dash/unit-05/screenshot.png)
