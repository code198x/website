...
After Dash taught you PPU fundamentals, Crate Escape focuses on **physics and movement**. Platformers defined the NES era, and this game teaches you why:
...
Complete **Game 1: Dash** first. You'll need the sprite management and controller input skills from that game.
