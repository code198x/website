...
Come from the [Commodore 64 Primer](/commodore-64/assembly)? You're ahead — the NES runs the same 6502 family, so every CPU idea transfers. What's new is the machine around the chip: a console that gives you nothing for free.
