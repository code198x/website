...
<CodeFromFile src="sinclair-zx-spectrum/basic/reflex/unit-01/wait.bas" />

Run it. "Get ready..." appears. A random pause — you do not know how long. Then "NOW!" Press any key. "You pressed!"

<Figure src="/images/sinclair-zx-spectrum/basic/reflex/unit-01/screenshot.png" alt="Black ZX Spectrum screen reading Get ready..., NOW!, You pressed!" caption="Wait for NOW!, press any key, and the program confirms: You pressed!" />
