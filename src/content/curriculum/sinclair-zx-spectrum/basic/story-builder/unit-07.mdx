...
<CodeFromFile src="sinclair-zx-spectrum/basic/story-builder/unit-07/titled.bas" />
...
<Figure src="/images/sinclair-zx-spectrum/basic/story-builder/unit-07/screenshot.png" alt="The Spectrum title screen reading STORY BUILDER above the first question" caption="The program announces itself before it asks anything." />
