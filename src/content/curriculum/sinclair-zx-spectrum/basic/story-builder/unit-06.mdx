...
<CodeFromFile src="sinclair-zx-spectrum/basic/story-builder/unit-06/titled.bas" />
...
<Figure src="/images/sinclair-zx-spectrum/basic/story-builder/unit-06/screenshot.png" alt="The Spectrum title screen reading STORY BUILDER above the first question" caption="The program announces itself before it asks anything." />
