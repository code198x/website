...
One round isn't much of a game. Five rounds with a running score turns it into a proper challenge — can you find all five treasures in as few moves as possible?
...
After five rounds, `NEXT n` advances to the next round — or falls through when `n` reaches 5.
