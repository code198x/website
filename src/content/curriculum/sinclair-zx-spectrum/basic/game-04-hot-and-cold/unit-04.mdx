...
The cursor moves, but it crashes at the edges and has nothing to search for. This unit fixes both — boundary checking keeps the cursor on screen, and a hidden treasure gives it a purpose.
...
The treasure is invisible. The player can't see it — but they can measure how far away they are.
