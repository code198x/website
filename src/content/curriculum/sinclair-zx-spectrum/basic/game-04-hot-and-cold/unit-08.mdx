...
You've built four games. You can put text anywhere on screen, move a cursor with the keyboard, calculate distances, and map numbers to colours. You know loops, variables, strings, conditions, and sound. In Game 5, you'll push strings further — slicing, joining, and shuffling letters to build a word puzzle.
