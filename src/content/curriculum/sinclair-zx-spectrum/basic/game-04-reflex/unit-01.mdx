...
Line 60 is the new idea: `IF INKEY$ = "" THEN GO TO 60`.
...
Line 40: `PAUSE INT (RND * 100) + 50`. The pause is between 50 and 149 frames — roughly 1 to 3 seconds. The player cannot predict when "NOW!" will appear, so they cannot cheat by pressing early.
