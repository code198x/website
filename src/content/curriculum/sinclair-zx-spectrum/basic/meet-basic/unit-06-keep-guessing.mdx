...
and count with predictable results. [Choose a new secret](/systems/sinclair-zx-spectrum/basic/meet-basic/unit-07-choose-a-new-secret/)
lets the Spectrum choose within the same range.
