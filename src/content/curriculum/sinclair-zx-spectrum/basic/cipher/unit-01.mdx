...
<Figure src="/images/sinclair-zx-spectrum/basic/cipher/unit-01/screenshot.png" alt="Partly-solved word S _ E _ T _ _ _ with the prompt Guess: L" caption="Each correct guess replaces its underscore; everything else stays hidden." />
