...
Two new lines: `30 PRINT "*** STORY BUILDER ***"` and `40 PRINT`. The title appears after CLS clears the screen, before the first question. The blank line on 40 separates the title from the questions.
