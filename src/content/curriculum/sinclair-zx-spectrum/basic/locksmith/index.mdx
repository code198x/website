...
The code and guess are stored in arrays; string parsing turns the typed guess into values to compare. What Locksmith adds is **comparing two arrays to score a guess** — and the genuinely tricky part, the **cow algorithm**: counting how many of each digit the code and the guess share, without double-counting the ones already placed. Getting that right is the heart of the game.
