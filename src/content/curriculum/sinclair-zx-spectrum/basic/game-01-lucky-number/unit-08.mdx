...
Over the next seven games, you'll learn FOR/NEXT, PRINT AT, BEEP, INKEY$, CLS, DATA/READ, and GO SUB/RETURN — the concepts that power the visual subroutines you've been treating as magic. Each game builds on what you know. Each game looks and feels like a real game from the very first unit.
