...
![The Spectrum's white screen surrounded by a solid blue border.](/images/sinclair-zx-spectrum/assembly/meet-the-machine/unit-03/screenshot.png)

A blue border. Here's the strange part: we didn't load the *number* 1 (blue's code). We loaded the **letter `'A'`**. The machine didn't blink — to it, `'A'` is simply 65, and we showed 65 on the border, where it lands on blue. A letter was a number all along.
