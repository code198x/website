...
<Figure src="/images/sinclair-zx-spectrum/assembly/meet-the-machine/unit-13/magenta-border.png" alt="The screen surrounded by a magenta border." caption="A magenta border — colour 3. We started at colour 2 (red) and OR'd in bit 0: red with blue added, one switch thrown, the rest untouched." />
...
<CodeFromFile src="sinclair-zx-spectrum/assembly/meet-the-machine/unit-13/working-with-bits.asm" />
...
```
asm198x --dialect pasmo --cpu z80 --tapbas working-with-bits.asm -o primer.tap
```
