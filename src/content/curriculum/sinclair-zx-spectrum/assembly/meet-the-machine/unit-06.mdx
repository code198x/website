...
```
asm198x --dialect pasmo --cpu z80 --tapbas colour-map.asm -o primer.tap
```
...
<CodeDiff
  before="sinclair-zx-spectrum/assembly/meet-the-machine/unit-06/colour-map.asm"
  after="sinclair-zx-spectrum/assembly/meet-the-machine/unit-06/colour-block.asm"
  lang="z80"
  title="Four cells coloured, one with the BRIGHT bit set"
  context={2}
/>
