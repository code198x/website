...
<Figure src="/images/sinclair-zx-spectrum/assembly/meet-the-machine/unit-11/two-bars.png" alt="A red bar above a blue bar, both full width, near the top of the screen." caption="Two rows — red above blue — both painted by the same fill_row routine, written once and called twice with a different row and colour each time." />
...
```
asm198x --dialect pasmo --cpu z80 --tapbas call-and-return.asm -o primer.tap
```
