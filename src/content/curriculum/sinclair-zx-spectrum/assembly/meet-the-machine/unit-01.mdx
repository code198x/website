...
<Figure src="/images/sinclair-zx-spectrum/assembly/meet-the-machine/unit-01/red-border.png" alt="The Spectrum's empty default screen surrounded by a solid red border." caption="A red border — and that's the win. Two instructions sent the value 2 to port $FE the instant the program ran." />
