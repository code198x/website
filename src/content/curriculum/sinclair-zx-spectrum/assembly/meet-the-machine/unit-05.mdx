...
<Figure src="/images/sinclair-zx-spectrum/assembly/meet-the-machine/unit-05/pixels.png" alt="A small mark near the top-left of the screen: a solid block running into a row of dots, with a second solid block one character-row below it." caption="Four bytes, drawn as pixels: a solid cell, two dotted cells beside it, and the puzzle byte at $4020 — which lands a whole character-row lower, not on the next pixel line." />
...
<CodeFromFile src="sinclair-zx-spectrum/assembly/meet-the-machine/unit-05/screen-is-memory.asm" />
...
<CodeDiff
  before="sinclair-zx-spectrum/assembly/meet-the-machine/unit-05/screen-is-memory.asm"
  after="sinclair-zx-spectrum/assembly/meet-the-machine/unit-05/dashed-line.asm"
  lang="z80"
  title="The dotted byte poked across eight cells: a dashed line"
  context={2}
/>
...
- **The pixels are there but invisible.** They're drawn in the cell's INK colour. If a cell's INK and PAPER happen to match, the pixels hide — we'll take charge of those colours in the next unit.
