...
```
asm198x --dialect pasmo --cpu z80 --tapbas screen-is-memory.asm -o primer.tap
```
...
- **The assembler errors on the binary value.** Eight bits, prefixed with `%`, no spaces: `%10101010`.
