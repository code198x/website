...
![A small mark near the top-left of the white screen: a solid block running into a row of dots, with a second solid block one character-row below it.](/images/sinclair-zx-spectrum/assembly/meet-the-machine/unit-05/screenshot.png)
...
<CodeFromFile src="sinclair-zx-spectrum/assembly/meet-the-machine/unit-05/dashed-line.asm" />
