...
<CodeFromFile src="sinclair-zx-spectrum/assembly/meet-the-machine/unit-16/no-safety-net.asm" />
...
```
asm198x --dialect pasmo --cpu z80 --tapbas no-safety-net.asm -o primer.tap
```
