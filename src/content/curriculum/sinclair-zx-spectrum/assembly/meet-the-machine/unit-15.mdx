...
<Figure src="/images/sinclair-zx-spectrum/assembly/meet-the-machine/unit-15/overrun.png" alt="A solid red block about eight rows tall near the top of the screen, its bottom-right corner stopping one cell short." caption="Meant to be one row; it's about eight, the bottom-right corner one cell short. The machine filled exactly 255 cells — the number we wrote — and never said a word." />
