...
<Figure src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-02/step-01-hall.png" alt="A dark, finely-textured slate floor filling a room, framed by a bright blue stone wall border, with the red hooded thief standing in the centre." caption="The keep's first hall: dark slate floor, lit stone walls — two shades of stone, both made from the same blue and black, separated only by dither density." />
...
<CodeDiff
  before="sinclair-zx-spectrum/assembly/shadowkeep/unit-02/steps/step-00.asm"
  after="sinclair-zx-spectrum/assembly/shadowkeep/unit-02/steps/step-01.asm"
  lang="z80"
  title="Step 1: the flat blue wash becomes a dithered hall of stone"
  context={3}
/>

<details>
<summary>The complete program</summary>
<CodeFromFile src="sinclair-zx-spectrum/assembly/shadowkeep/unit-02/steps/step-01.asm" lang="z80" />
</details>
...
The hall is built, but the thief is rooted to the spot. In **Unit 3, "A Place to Move,"** we bring back Gloaming's keyboard reading, cell-step movement, and wall collision — and set the thief walking the hall. He'll save and restore the dithered stone beneath him as he goes, so the floor survives his passing, and the lit walls will turn him back. The engine you finished — Gloaming's, deepened across The Long Night — now moving a thief through a room of stone.
