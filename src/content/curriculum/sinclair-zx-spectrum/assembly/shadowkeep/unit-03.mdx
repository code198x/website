...
<Figure src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-03/step-01-against-wall.png" alt="The hooded thief, having walked up and to the left, stopped against the top wall of lit blue stone; the dark slate floor below him is unbroken, with no trail." caption="Walked up and to the left, stopped hard against the lit stone — and the slate behind him is whole. He leaves the floor exactly as he found it." />
...
<CodeDiff
  before="sinclair-zx-spectrum/assembly/shadowkeep/unit-03/steps/step-00.asm"
  after="sinclair-zx-spectrum/assembly/shadowkeep/unit-03/steps/step-01.asm"
  lang="z80"
  title="Step 1: QAOP movement, wall-by-light, and save/restore the stone"
  context={3}
/>

<details>
<summary>The complete program</summary>
<CodeFromFile src="sinclair-zx-spectrum/assembly/shadowkeep/unit-03/steps/step-01.asm" lang="z80" />
</details>
...
<VideoPlayer
  src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-03/step-01-walk.mp4"
  caption="QAOP walks the thief cell by cell. He stops dead against the lit stone on all four sides, and the dithered floor closes seamlessly behind every step — save the stone, move, restore it. The engine Gloaming built, now carrying texture."
  autoplay={true}
  loop={true}
/>
