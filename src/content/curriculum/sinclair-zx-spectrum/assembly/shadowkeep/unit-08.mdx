...
<Figure src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-08/step-01-gallery.png" alt="The Gallery — a room split across the middle by a wall with a single gap; the red thief stands just inside its west doorway, with another doorway gap at the top leading further in." caption="The Gallery — bisected by a wall with one gap, a west door the thief stepped through, and a north door at the top leading on. Same engine as the Hall, an entirely different room to play — built only from where the walls are." />
...
<CodeDiff
  before="sinclair-zx-spectrum/assembly/shadowkeep/unit-08/steps/step-00.asm"
  after="sinclair-zx-spectrum/assembly/shadowkeep/unit-08/steps/step-01.asm"
  lang="z80"
  title="Step 1: a third room and the links that join the keep"
  context={3}
/>

<details>
<summary>The complete program</summary>
<CodeFromFile src="sinclair-zx-spectrum/assembly/shadowkeep/unit-08/steps/step-01.asm" lang="z80" />
</details>
...
<VideoPlayer
  src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-08/step-01-tour.mp4"
  caption="East out of the pillared Hall into the bisected Gallery, up through its one gap into the Vault, and around the altar that can't be crossed. Three rooms, three characters — all of it laid out from where the walls are, on the engine the sub-arc built. Hold SPACE as you go and the keep would chalk your route, room by room."
  autoplay={true}
  loop={true}
/>
