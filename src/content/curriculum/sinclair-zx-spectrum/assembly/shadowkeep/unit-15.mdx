...
The keep is a complete game — but it opens in silence. A game announces itself; it has a *theme*, the few seconds of music that tell you what you're about to play. You have written one before — the dusk bells that tolled over *The Long Night*'s title, note and keyboard-poll interleaved so a waiting keypress was never swallowed. The keep deserves its own, on the same instrument: the single-bit beeper from Unit 13, asked now to carry not a footstep but a *tune* — and holding, again, to the discipline a title tune owes the player.
