...
<Figure src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-06/step-01-at-door.png" alt="The second chamber, with the red thief standing right at the doorway gap in its west wall, mid-height — exactly where he'd emerge after stepping east through the first room's east door." caption="Walked east, arrived at the next room's west doorway — at the same height he left, not dumped in the middle. The seam reads as a step through the wall, not a blink." />
...
<CodeDiff
  before="sinclair-zx-spectrum/assembly/shadowkeep/unit-06/steps/step-00.asm"
  after="sinclair-zx-spectrum/assembly/shadowkeep/unit-06/steps/step-01.asm"
  lang="z80"
  title="Step 1: arrive at the opposite edge, same height — a step, not a teleport"
  context={3}
/>

<details>
<summary>The complete program</summary>
<CodeFromFile src="sinclair-zx-spectrum/assembly/shadowkeep/unit-06/steps/step-01.asm" lang="z80" />
</details>
...
<VideoPlayer
  src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-06/step-01-step.mp4"
  caption="East through the hall's doorway — and the thief steps in at the next room's west doorway, the same height he left, then walks on into the chamber. His position across the seam is preserved; only the side flipped. A teleport became a step."
  autoplay={true}
  loop={true}
/>
