...
<Figure src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-04/step-01-pillars.png" alt="A walled hall with four bright-blue stone pillars arranged in a square on the dark slate floor, the red thief standing among them." caption="Four stone pillars standing in the hall — a shape no position test could draw, laid out from a readable map. The thief walks between them and stops at each, on the same collision code as Unit 3." />
...
<CodeDiff
  before="sinclair-zx-spectrum/assembly/shadowkeep/unit-04/steps/step-00.asm"
  after="sinclair-zx-spectrum/assembly/shadowkeep/unit-04/steps/step-01.asm"
  lang="z80"
  title="Step 1: a tile palette and a readable room map drive the room"
  context={3}
/>

<details>
<summary>The complete program</summary>
<CodeFromFile src="sinclair-zx-spectrum/assembly/shadowkeep/unit-04/steps/step-01.asm" lang="z80" />
</details>
