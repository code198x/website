...
<Figure src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-16/step-01-hall.png" alt="The Hall lit by three sconces — one high in the centre wall and one on each side wall — their pools of light overlapping across the upper hall around the statue and banners, the floor falling into shadow below; the hooded thief and the pale Warden in the light, coins on the right." caption="The Hall, grandly lit: three sconces, their pools overlapping into a broad wash across the upper chamber, the statue and banners standing in it, the thief and Warden moving through it, the floor sinking to shadow at the back. The light is no longer one circle but as many as the room has fires." />

The Hall, grandly lit now — three flames, their pools overlapping into a broad wash of light across the upper chamber, the statue and its banners standing in it, the thief and the Warden moving through it, the floor sinking to shadow toward the back. Walk to the Vault and it's still a single flame in the black; the Gallery, two torches and a medium glow. One keep, one engine, three characters — and they feel like *the same keep*, lit by the same hand.
...
<Figure src="/images/sinclair-zx-spectrum/assembly/shadowkeep/unit-16/step-01-vault.png" alt="The Vault, lit by a single flame on the central altar: a tight pool of light around the altar, the rest of the room near-black, the coins and Warden faint in the dark, the hooded thief entering from the south doorway below." caption="The same keep, the opposite character: the Vault's one cold flame and sharp falloff against the Hall's three sconces and broad wash. Same stone, same dither ramp, same fire — one number each sets them apart, and they still read as one building." />
...
hall. Paired with the per-room falloff from Unit 15, two dials — count of flames and
...
Drop another `T` into a room's map and watch a new pool bloom and overlap the others; delete one and watch a corner fall dark. You're lighting by placing fires — the most physical way there is. Mind `MAX_TORCHES`; raise it if you want a room ablaze. (Keep them clear of a Warden's route, or you light the danger and not the gold.)
...
The keep looks like somewhere now — lit, furnished, composed — and it plays. But it's near-silent: the coins chime, the win and the loss sound, and otherwise the stone is mute. A place you believe in has *ambient* sound — footsteps on stone, the creak of a door. The next sub-arc, **The Keep's Voice**, gives it that. We begin in **Unit 17, "Footsteps and Doors,"** building on the beeper you rang the dusk bells with — turned now to stone and hinges — so the keep is heard as well as seen.
