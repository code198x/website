...
<MemoryMap
  ...
  ranges={[
    ...
    { start: 0x8000, end: 0x80FF, label: "Your program", sublabel: "org 32768" },
  ]}
  caption="The Spectrum's screen sits at the bottom of RAM: the bitmap first, the attribute table right behind it. Our program loads well clear at 32768."
/>
...
<RegisterBits
  ...
  bits={[
    { index: 7, label: "FLASH" },
    { index: 6, label: "BRIGHT" },
    { index: 5, label: "Paper 2" },
    { index: 4, label: "Paper 1" },
    { index: 3, label: "Paper 0" },
    { index: 2, label: "Ink 2" },
    { index: 1, label: "Ink 1" },
    { index: 0, label: "Ink 0" },
  ]}
  value={0x0f}
  caption="The wall byte, $0F: PAPER %001 (blue), INK %111 (white), FLASH and BRIGHT clear. The cobble byte $01 differs only in PAPER — %000, black."
/>
