...
<RegisterBits
  ...
  bits={[
    ...
    { index: 6, label: "1" },
    { index: 5, label: "0" },
    { index: 4, label: "Third 1", active: true },
    { index: 3, label: "Third 0", active: true },
    { index: 2, label: "0" },
    { index: 1, label: "0" },
    { index: 0, label: "0" },
  ]}
  caption="H: the fixed %010 of the $4000 screen base, then the row's third — the tt bits, kept exactly where they sat in the row number."
/>
...
<RegisterBits
  ...
  bits={[
    { index: 7, label: "Row 2", active: true },
    { index: 6, label: "Row 1", active: true },
    { index: 5, label: "Row 0", active: true },
    { index: 4, label: "Col 4" },
    { index: 3, label: "Col 3" },
    { index: 2, label: "Col 2" },
    { index: 1, label: "Col 1" },
  ...
  caption="L: the character row within the third — the rrr bits, rotated up to the top — then the column in the low five bits."
/>
