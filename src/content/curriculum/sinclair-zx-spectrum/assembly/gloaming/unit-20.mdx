...
And playing it on the metal earns you one last discovery: with real hands on a real keyboard, you can *hear* what the emulator sessions never made you notice. **Unit 21, "Three Phrases"**, is about exactly that — the silences — and it is the shortest unit in the game.
