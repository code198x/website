...
Unit 2 taught the whole trick: eight `defb` bytes, stamped into a cell's bitmap by `blit_tex`'s `inc h` walk. A character's shape is exactly the same kind of data. Here is the lamplighter — hood, lantern arm out, feet apart on the cobbles:

```
%00111100    ..XXXX..    the hood
%00111100    ..XXXX..
%00011000    ...XX...    the neck
%01111110    .XXXXXX.    arms out — one holds the pole
%00011000    ...XX...    the body
%00011000    ...XX...
%00100100    ..X..X..    legs
%01000010    .X....X.    feet, apart
```
