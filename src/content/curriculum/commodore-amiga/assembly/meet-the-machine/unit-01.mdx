...
This is the Primer — *Meet the Machine*. Its whole job is to make the [Commodore Amiga](/commodore-amiga) stop feeling like magic, one small idea at a time. No game yet, no sprites, no clever code. Just you and the machine, getting introduced.

If you've come from one of the 8-bit Primers — [Spectrum](/sinclair-zx-spectrum/assembly), [C64](/commodore-64/assembly) or [NES](/nintendo-entertainment-system/assembly) — a word before we start: **expect more to be new here than to carry over.** Those machines ran 8-bit CPUs (the Z80, the 6502). The Amiga runs the **Motorola 68000** — a 16/32-bit processor with a different instruction set, far more registers, and a family of **custom chips** that do the graphics and sound for you. The *way of thinking* transfers. Almost none of the actual instructions do. That's the point of meeting it properly.
