...
You've met variables, loops, conditionals and subroutines somewhere — [the Foundations modules](/foundations), our BASIC courses, or any language. New to programming entirely? Start with [The Basics](/foundations/basics) first, then come back; AMOS is a lovely *second* step, but it builds on those foundations.
