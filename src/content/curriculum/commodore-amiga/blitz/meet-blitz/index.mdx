...
You've met variables, loops, conditionals and procedures somewhere — [General Programming](/foundations/general-programming), our BASIC courses, [Meet AMOS](/systems/commodore-amiga/amos), or any language. New to programming entirely? Start with [General Programming](/foundations/general-programming) first, then come back.
