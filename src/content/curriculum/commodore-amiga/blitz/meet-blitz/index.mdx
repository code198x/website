...
You've met variables, loops, conditionals and procedures somewhere — [the Foundations modules](/foundations), our BASIC courses, [Meet AMOS](/systems/commodore-amiga/amos), or any language. New to programming entirely? Start with [The Basics](/foundations/basics) first, then come back.

You don't need to have done [Meet AMOS](/systems/commodore-amiga/amos) — Blitz stands on its own. If you *have*, you'll feel the contrast straight away: AMOS hands you game verbs and runs them interpreted; Blitz hands you faster, lower-level tools and compiles them to the metal. Neither is "better" — they're different trades, and the Amiga is the rare machine that lets you feel both.
