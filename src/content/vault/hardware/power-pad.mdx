...
sources:
  introduced:
    - title: "Name-collision check against the reference corpus"
      kind: database
      note: "⚠ 55 pages predate 1986 under this name and none are Nintendo's. They are Chalk Board Inc's PowerPad, a graphics tablet for the Atari and Commodore machines advertised from 1982, plus an unrelated uninterruptible power supply. A corpus search on \"Power Pad\" alone will date this accessory three years too early"
discontinued: 1988
---
