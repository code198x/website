...
Nintendo's *MMC3 Specification*, third edition dated 24 May 1988, describes the interval timer very differently from the way emulator authors do — and both descriptions are correct.

**Nintendo calls it a one-line timer.** Its summary of the part gives the timer's clock simply as one horizontal line, and its timing diagram measures the period at 63.51 microseconds. There is no mention of A12 at that level, because from a game programmer's seat the counter *is* a scanline counter.
