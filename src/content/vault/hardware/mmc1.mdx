...
sources:
  naming:
    - title: "MMC programming specification, Nintendo (November 1986)"
      kind: technical-doc
      page: "1"
      note: "In Japanese. Page 1 heads the part 'MMC' and spells out the abbreviation in katakana as マルチメモリコントローラ, Multi Memory Controller"
    ...
    - title: "NESdev Wiki, mapper documentation"
      kind: database
      page: "§2"
      note: "Community reference. It records the English-language uncertainty: MMC 'may have originally stood for \"Multi Memory Controller\", at least according to Japanese'"
  serial:
