...
sources:
  ...
  multi_machine:
    - title: "Computer Battlegames, Usborne Publishing"
      ...
      note: "The series' defining constraint, visible on one cover: VIC-20, Apple, TRS-80, Spectrum and ZX81 all listed, with the contents page giving the same program a separate entry per machine. Usborne wrote for a readership that owned different computers and could not be assumed to own any particular one"
  holdings:
...
platforms: ['sinclair-zx-spectrum', 'commodore-64', 'bbc-micro', 'amstrad-cpc', 'sinclair-zx81']
...
- [Type-in programs](/vault/distribution/type-in-listings) — The companion magazine tradition.
