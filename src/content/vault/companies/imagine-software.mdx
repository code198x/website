...
sources:
  founded:
    - title: The History of Ocean Software
      kind: modern-book
      page: "15"
      note: "in 1982 Mark Butler, Dave Lawson, and Eugene Evans left to form Imagine, and asked Paul if he would help them on the sales side"
name_reused_by:
...
## Who left Bug-Byte, and when

The entry above has the founders coming from [Bug-Byte](/vault/companies/bug-byte). *The
History of Ocean Software* — written from interviews with people who were in the same Liverpool
rooms — names them and dates it: **in 1982 Mark Butler, Dave Lawson and Eugene Evans left to
form Imagine**, and recruited Paul Finnegan to run sales. Finnegan sold his half of a printing
business to join.

His account of what happened next is the whole story in two sentences:

> It was an incredible business, you know, the amount of money coming in was fantastic… but it
> was going out the other door. Everybody had a nice car, **even the cleaners had a Porsche!**

The Porsches are usually told as a symbol. Finnegan is describing a cash-flow problem: revenue
arriving and leaving at the same rate, which is survivable only while revenue keeps growing.

He did not stay to watch. After falling out with operations director **Bruce Everiss** —
"it just didn't work for me, so in the end I decided to get away" — he went to Jon Woods and
David Ward, who were then trading as **Spectrum Games**, and swapped a company car for the
firm's transport: "at Spectrum Games all I got was the old props van. It was a Peugeot estate.
If you'd put a rocking horse on top it'd look like the Clampett wagon from *Beverly
Hillbillies*."

That is the Liverpool-to-Manchester transfer in miniature, and it happened before the collapse
