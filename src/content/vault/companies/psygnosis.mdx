...
⚠ **This entry previously said Psygnosis was originally registered as "Psyclapse Ltd" and
renamed shortly afterwards. That is wrong.** Psyclapse was a **sublabel launched in 1988**,
four years after the company was founded. *ACE* carried the announcement — a new label from
Psygnosis — and its first release was the shoot-'em-up *Menace*, which the magazine noted was
pointedly **not** in the megagame mould.
...
On what came next, and the date this entry had wrong: Hetherington places *Barbarian* in the
**summer of 1986**, released simultaneously on Amiga and ST. ⚠ The fast facts previously gave
1987.
...
That decision is the origin of everything this entry credits the company with visually. The
...
⚠ **A note on sourcing.** Much of this entry — the twelve parallax planes, the Reflections
and DMA attributions, the Net Yaroze claim, the closure details — is not yet grounded in the
period press held by this library, which is thin on the 32-bit era. The 1986–89 material
above is sourced; treat the PlayStation-era sections as unverified pending a later pass.
