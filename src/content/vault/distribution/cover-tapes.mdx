...
sources:
  the_duplicator:
    - title: "Amstrad Action, covertape returns addresses (issues 67, April 1991 and 79, April 1992)"
      kind: magazine
      page: "covertape pages"
      note: "Names the industry this entry describes as 'a duplication house'. Amstrad Action's returns address is 'AA67 Covertape Returns, Ablex Audio Video Ltd, Harcourt, Halesford 14, Telford, Shropshire TF7 4QD' - and it is renumbered per issue, AA67 then AA79, so faulty tapes were handled batch by batch against the specific month's run. Duplication was contracted out to a named audio-video house, not done by the publisher"
  tapes_failed_often:
    - title: "Amstrad Action issue 67 (April 1991) - covertape troubleshooting"
      kind: magazine
      page: "covertape pages"
      note: "⚠ OCR is rough on this page, so it is described rather than quoted at length. Beside the returns address the magazine prints loading advice that says a great deal about the medium's reliability: check the volume, because 'computers can be very fussy about the volume they will load at'; clean the tape heads with a proprietary cleaner or 'a cotton bud soaked in alcohol', rubbing the head and pinch roller to remove accumulated grime; and adjust the recorder's head alignment, the screw for which sits just to the left of the tape head. A magazine giving away a cassette had to teach its readers tape-deck maintenance to make it load"
  both_sides_used:
    - title: "Amstrad Action issue 79 (April 1992)"
      kind: magazine
      page: "covertape pages"
      note: "How full these things got: 'This month's covertape is so packed that we've had to split the pokes into two sets. Group A is on side one, Group B is on side two.' Both sides of a C15 cassette, with an index in the magazine telling readers which side to wind to"
---
...
## The duplication house was a real company with an address

Step two below — "a duplication house mass-produced cassettes" — has a name on
it. *Amstrad Action*'s faulty-tape returns went to **Ablex Audio Video Ltd**, of
Halesford 14, Telford, Shropshire, and the address was renumbered every issue —
"AA67 Covertape Returns", then "AA79 Covertape Returns" — so each month's run was
handled as its own batch.

And they did fail. Alongside the returns address the magazine printed tape-deck
maintenance advice: check your volume, because computers "can be very fussy about
the volume they will load at"; clean the heads with a proprietary cleaner or a
cotton bud soaked in alcohol, rubbing head and pinch roller to shift accumulated
grime; and adjust the head alignment using the screw just left of the tape head.

A magazine giving away software had to teach its readers to service their
cassette decks before the gift would work. That is the cover tape's economics and
its limits in one page.

By 1992 the tapes were full on both sides — *"This month's covertape is so packed
that we've had to split the pokes into two sets. Group A is on side one, Group B
is on side two."*
...
The economics above assume the cassette works. Mass duplication at a third of a penny a
minute did not always deliver that, and the recurring complaints were consistent:

- **Duplication quality.** Cover tapes were produced in far larger runs and to a lower
  standard than commercial releases, and a bad batch meant a magazine's whole print run
  loaded badly.
- **Loading reliability.** A cassette that had been glued to a magazine, posted, and stacked
  on a newsagent's shelf had a harder life than one sold in a case.
- **Multi-load programs.** Fitting four to six programs across two sides meant careful
  sequencing, and a reader hunting for the fourth program had to wind to it by counter.

Cover disks inverted every one of these: higher cost per unit, but far less prone to error,
faster to load, and able to carry much more.
...
3. **Anticipated digital distribution.** The "free game with the magazine" model anticipated modern digital-distribution sampling — Humble Bundle, PlayStation Plus and Xbox Game Pass, the Epic Games Store's weekly giveaways, and the expectation that a demo should exist at all. The conceptual pattern is the same: bundle samples with a subscription; let discovery drive future purchases.
...
## An earlier answer to the same problem

The cover-mounted tape is a British form with a British date, and this entry
describes it as such. It is worth noting that the problem it solved — readers who
wanted the programs without the typing — had been answered differently and much
earlier elsewhere.

*[MICRO-80](/vault/magazines/micro-80)*, an Australian TRS-80 monthly, offered
every issue's listings on a companion cassette from its **first issue in December
1979**: $3.50 on top of the cover price, or a year of magazine plus cassette for
$60. Nothing was attached to the cover and nothing was free — it was a separate
purchase, bought by subscribers who wanted it.

So the cassette-instead-of-typing idea is a decade older than the British cover
tape. What 1989 changed was not the medium but the economics: giving the software
away on the front of the magazine, paid for by cover price and licensing rather
than by the reader choosing to buy it.
...
- [CRASH](/vault/magazines/crash-magazine), [Sinclair User](/vault/magazines/sinclair-user), [Zzap!64](/vault/magazines/zzap-64) — The other major cover-tape magazines.
