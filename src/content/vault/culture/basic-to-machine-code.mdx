...
- Typed in a handful of [magazine listings](/vault/distribution/type-in-listings) and a few Usborne games.
...
The discipline of the tradition — careful, slow, listing-driven, modification-encouraged — was largely lost to mainstream programming education for two decades.
...
- [Type-in programs](/vault/distribution/type-in-listings) — Including assembly listings via MLX.
