...
- [Machine code for beginners](/vault/culture/machine-code-for-beginners) — Where the advanced POKE-finders started.
- [Sinclair BASIC](/vault/techniques/sinclair-basic) — The language `POKE` is a keyword in.
