...
tags: ['books', 'education', 'programming', 'usborne', 'british-publishing']
emerged: 1982
ended: 1987
...
5. **Reading age assumption: 9-12.** The series targets primary-school readers. The vocabulary, sentence length, and concept introduction are calibrated for that audience — which makes the books exceptionally accessible to adult beginners who find professional documentation impenetrable.
...
- [Sinclair BASIC](/vault/techniques/sinclair-basic) — The language the Spectrum-side Usborne books taught.
- [Machine code for beginners](/vault/culture/machine-code-for-beginners) — The Usborne assembly book and the tradition it created.
- [Bedroom coder](/vault/culture/bedroom-coder) — Where the Usborne path often led.
