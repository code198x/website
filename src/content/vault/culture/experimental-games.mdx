...
- **Enablers:** indie tools (Game Maker, [Unity](/vault/tools/unity), Twine).
- **Platforms:** itch.io, [game jams](/vault/culture/game-jams), art installations.
- **Recognition:** museum exhibitions, academic study.
- **Intersection:** [art games](/vault/genres/art-games), notgames, walking simulators.
