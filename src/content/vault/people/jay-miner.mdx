...
## Fast facts
- **Atari years:** designed the Television Interface Adaptor (TIA) for the [Atari 2600](/vault/systems/atari-2600), the chip that handled graphics and sound in a single package.
- **The Amiga dream:** founded Hi-Toro (later Amiga Corporation) in 1982 to build the computer [Atari](/vault/companies/atari) wouldn't let him make.
...
- **Commodore acquisition:** Amiga Corp was bought by [Commodore](/vault/companies/commodore) in 1984, and the Amiga 1000 launched in 1985.
