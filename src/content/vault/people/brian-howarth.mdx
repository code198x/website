...
This is the same insight that [the Quill](/vault/techniques/quill) turned into a product for everybody else in 1983 — and Howarth had arrived at it independently, for himself, to keep shipping.
...
Howarth is the entry for **the reusable engine**, arrived at from necessity by an author who wanted to write nine games and had time for one program.
