...
- **Founded:** [Magnetic Scrolls](/vault/companies/magnetic-scrolls) with Ken Gordon and Hugh Sheridan, 1984.
- **Innovation:** developed cross-platform engine running on 8-bit and 16-bit systems.
- **Parser:** Magnetic Scrolls' parser rivalled [Infocom](/vault/companies/infocom) for natural language understanding.
