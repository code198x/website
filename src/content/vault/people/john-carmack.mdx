...
- **Early work:** [Apple II](/vault/systems/apple-ii) games, freelance programming.
- **id Software:** Co-founded 1991 with [John Romero](/vault/people/john-romero), Tom Hall, Adrian Carmack.
- **Engine innovations:** Adaptive tile refresh, raycasting, [BSP trees](/vault/techniques/bsp-trees), client-server networking.
