...
- **Scenes:** [Demoscene](/vault/communities/demo-scene-101), music (SID), cracking groups, BBSes
...
- [Commodore](/vault/companies/commodore) — the company behind the C64
- [VIC-II Chip Reference](/vault/hardware/vic-ii-chip) — graphics hardware programming
- [Inside the VIC-II](/vault/hardware/vic-ii) — historical context
- [SID: The Sound of the C64](/vault/hardware/sid-chip) — audio chip
- [KERNAL I/O Routines](/vault/techniques/kernal-io) — system calls
- [Screen Memory](/vault/techniques/screen-memory) — display memory layout
- [PETSCII Chart](/vault/techniques/petscii-chart) — character codes
- [Bob Yannes](/vault/people/bob-yannes) — SID chip designer
- [Al Charpentier](/vault/people/al-charpentier) — VIC-II chip designer
- [Rob Hubbard](/vault/people/rob-hubbard) — legendary SID musician
- [Martin Galway](/vault/people/martin-galway) — SID composer
- [Ben Daglish](/vault/people/ben-daglish) — SID composer
- [Jeroen Tel](/vault/people/jeroen-tel) — SID composer
- [Disk Fastloaders](/vault/techniques/disk-fastloaders) — speeding up the 1541
