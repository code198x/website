...
sources:
  introduced:
    - ref: magazines/crash-magazine
      ...
      date: "1987-07"
      issue: 42
      note: "the first British review of the machine, headed \"an arcade machine in your home\": \"the Nintendo features 52 colours, 256 by 240 pixel resolution and 64 sprites\". 27 titles then available; Mattel's own claim that the current software used \"approximately 20% of the machine's capabilities\". The news pages of the same issue report Mattel cutting the basic set from £129.99 to £99.99 and the deluxe from £199.99 to £155, \"following trade criticism of the high original prices\""
    - ref: magazines/computer-and-video-games
      kind: advertisement
      date: "1987-06"
      note: "Nintendo's UK launch advertisement, run across CRASH 41, Computer Gamer 27, C&VG 68 and ZZAP!64 27: \"For the first time in the UK direct from Japan comes Nintendo\""
    - title: "Your Computer, October and December 1986"
      kind: magazine
      note: "in October a reader asks \"When will it be available in the U.K.?\"; in December the machine \"has no official price tag yet but it will probably be in the region of £100\". Through 1986 the British press covers the Nintendo as forthcoming, not as sold"
    - ref: magazines/computer-and-video-games
      kind: magazine
      date: "1987-11"
      issue: 73
      note: "\"around eight million units in use. In Japan it is called the Famicom — Family Computer — and has been around for several years\""
    - title: "syntheses/nintendo-nes/ppu-rendering-pipeline.md"
      kind: technical-doc
      note: "256×240 output over 341 dots × 262 scanlines (NTSC) or 312 (PAL); eight sprites per scanline, the ninth suppressed and the overflow flag set; 32 bytes of palette RAM at $3F00-$3F1F indexing a 64-entry generated colour table"
    - title: "syntheses/nintendo-nes/2a03-cpu-timing-and-dma.md"
      kind: technical-doc
      note: "1.789773 MHz (NTSC) / 1.662607 MHz (PAL); the D flag is present but inert — SED and CLD execute, ADC and SBC ignore it"
    - title: "syntheses/nintendo-nes/common-mappers-walkthrough.md"
      kind: technical-doc
      note: "MMC3 counts rising edges on PPU address line A12, which yields one edge per scanline only where sprites and background use different pattern tables"
