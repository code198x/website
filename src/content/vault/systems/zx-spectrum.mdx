...
sources:
  introduced:
    ...
    - title: "syntheses/zx-spectrum/ula-contention-model.md"
      kind: technical-doc
      note: "the contention pattern 6,5,4,3,2,1,0,0 at T-state granularity; contended RAM is $4000-$7FFF on a 48K machine"
