...
processor's address space. The [Spectrum](/vault/systems/sinclair-zx-spectrum) writes
pixels at `$4000`, the [C64](/vault/systems/commodore-64) at `$0400`, the
[VIC-20](/vault/systems/commodore-vic-20) wherever the expansion left it. On MSX the video
