...
- **Release:** December 1987 ([Atari ST](/vault/systems/atari-st)).
...
## Where it did not go
FTL's *Dungeon Master* was an Atari ST game first and an Amiga game second. It
had no Spectrum version, and the Spectrum press mentions of the phrase are the
tabletop role — plus Crystal Computing's unrelated 1984 Spectrum game *The
Dungeon Master*, which shares only a name.
