...
✅ **This entry used to sit on the `international-karate` slug while describing
the sequel, with the 1985 original missing entirely.** It has been moved to
`international-karate-plus`, and
[*International Karate*](/vault/games/international-karate) now has its own entry.
