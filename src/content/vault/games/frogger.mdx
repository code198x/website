...
Our [Signal](/commodore-amiga/assembly/game-02-signal) game teaches these mechanics on the Amiga, using sprites, the Blitter, and the Copper to recreate the *Frogger* experience.
