...
category: "games"
platforms: ['nintendo-entertainment-system', 'pc-engine', 'super-nintendo']
...
- **Original platform:** [MSX](/vault/systems/msx), PC, NES.
- **Creator:** Shinichi Nakamoto.
- **Multiplayer:** up to 5 players (with multitap).
- **Peak era:** *Super Bomberman* series on SNES.
- **Current owner:** [Konami](/vault/companies/konami) (acquired Hudson Soft, 2012).
