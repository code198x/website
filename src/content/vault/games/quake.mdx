...
- **Developer:** [id Software](/vault/companies/id-software).
- **Engine:** Quake engine ([id Tech](/vault/tools/id-tech) 2).
- **Innovation:** True 3D, [online multiplayer](/vault/culture/online-multiplayer).
