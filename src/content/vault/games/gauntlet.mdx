...
category: "games"
platforms: ['arcade', 'nintendo-entertainment-system', 'commodore-64', 'sinclair-zx-spectrum', 'commodore-amiga', 'amstrad-cpc', 'atari-st', 'atari-7800', 'msx', 'sega-master-system']
...
## Fast facts
- ***CRASH*:** **92%**, issue 37 — confirmed against the magazine's own index (issue 37, p16), a later re-citation in *[CRASH](/vault/magazines/crash-magazine)* itself and the rating panel in issue 37 (February 1987), p17.
- **Developer:** [Atari Games](/vault/companies/atari) ([Ed Logg](/vault/people/ed-logg)).
