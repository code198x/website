...
*CRASH* gave it **95%** in May 1984 and *Personal Computer Games* **10/10** the same month, with *Sinclair User* at 9/10 in June and *Big K* a full 3/3. A near-unanimous verdict for a game that shipped, famously, in an unfinishable state.
