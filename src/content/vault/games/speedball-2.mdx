...
- **Publisher:** ImageWorks ([Mirrorsoft](/vault/companies/mirrorsoft)).
- **Release:** 1990 (Amiga original).
- **Setting:** dystopian future, legalised violent sport.
- **Team:** Brutal Deluxe, starting from the bottom.
- **Platforms:** Amiga, [Atari ST](/vault/systems/atari-st), PC, C64, Mega Drive, and more.
...
There was no Spectrum conversion. The only appearances of *Speedball 2* in the
Spectrum press are a premium-rate competition advertising "the top ten Amiga
games of today" — the same advert placed in *CRASH*, *Sinclair User* and *Your
Sinclair* in July 1991.
