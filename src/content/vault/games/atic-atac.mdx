...
sources:
  released:
    - ref: magazines/computer-and-video-games
      ...
      issue: 25
      date: "1983-11"
      note: "earliest dated appearance in the British press held here; 10 pages in 1983, rising to 133 in 1984"
...
It's the game most directly cited as the inspiration for [Shadowkeep](/systems/sinclair-zx-spectrum/assembly/shadowkeep). The top-down view, the multi-room engine, the colour-coded keys and doors, the food-and-find-the-key gameplay loop — *Atic Atac* established all of them. What Ultimate would do next ([Sabre Wulf](/vault/games/sabre-wulf), then *Knight Lore* in 1984) built on the *Atic Atac* foundation, expanding the world or the perspective without changing the basic adventure shape.
...
Alien 8 (95%, Issue 15)". *Sinclair User* gave it five stars. Both magazines treated it as a step-change in what Spectrum adventures could be. The game became a Christmas 1983 bestseller, helping cement Ultimate's reputation as the platform's most ambitious developer.
