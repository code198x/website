...
## Fast facts
- ***CRASH*:** **90%**, issue 45 — confirmed against the magazine's own index (issue 45, p132), a later re-citation in *CRASH* itself and the rating panel in issue 45 (October 1987), p133.
