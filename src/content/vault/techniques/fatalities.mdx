...
- **Origin:** *[Mortal Kombat](/vault/games/mortal-kombat)* ([Midway](/vault/companies/midway), 1992).
- **Designers:** [Ed Boon](/vault/people/ed-boon) and [John Tobias](/vault/people/john-tobias).
- **Input:** Hidden button + direction combinations during a brief "Finish Him/Her!" window.
- **Controversy:** Catalysed the 1993 Senate hearings and [ESRB](/vault/culture/esrb) formation.
