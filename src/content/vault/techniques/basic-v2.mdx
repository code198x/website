...
See [Screen Memory](/vault/techniques/screen-memory) and [VIC-II Chip](/vault/hardware/vic-ii-chip) for complete maps.
...
- [VIC-II Chip](/vault/hardware/vic-ii-chip) — graphics registers
