...
- **Origin:** Ultimate Soundtracker (Amiga, 1987); refined by [ProTracker](/vault/tools/protracker) (Amiga, 1990).
...
- [MOD Format (cultural perspective)](/vault/techniques/mod-format) — demoscene impact, BBS distribution, scene history
