...
| Aspect | Detail |
|--------|--------|
| **Defining game** | *OutRun* ([Sega](/vault/companies/sega), 1986) |
| **Originator** | *[Pole Position](/vault/games/pole-position)* ([Namco](/vault/companies/namco), 1982) |
| **Key insight** | Perspective = scale by 1/distance |
| **Hardware needs** | Sprite scaling (Sega Super Scaler) or fast software |
| **Modern term** | "Pseudo-3D" or "fake 3D" — though related to [Mode 7](/vault/techniques/mode-7) in spirit |
