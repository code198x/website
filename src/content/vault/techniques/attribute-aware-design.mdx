...
**2. Block alignment.** Force all moving sprites to occupy whole 8×8 cells. The sprite snaps to the grid; cell attributes change cleanly as the sprite moves cell-by-cell rather than smoothly. The cost is choppy motion, which is why arcade-style games rarely took it; the gain is that clash becomes impossible rather than merely avoided.
