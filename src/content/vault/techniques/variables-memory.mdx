...
| Top of BASIC | POKE values | Free RAM | Notes |
|--------------|-------------|----------|-------|
| `$C000` (49152) | `POKE 56,192:POKE 55,0:CLR` | $C000-$CFFF = **4 KB** | $D000+ is I/O; $E000+ is KERNAL |
| `$A000` (40960) | `POKE 56,160:POKE 55,0:CLR` | $A000-$BFFF + $C000-$CFFF = **8 KB** | Only if BASIC ROM is banked out at $A000 |
| `$8000` (32768) | `POKE 56,128:POKE 55,0:CLR` | $8000-$9FFF + $A000-$CFFF = **12 KB** | Same caveat about banking |
| `$3000` (12288) | `POKE 56,48:POKE 55,0:CLR` | $3000-$9FFF = **28 KB** | Common for ML game engines that load high |
