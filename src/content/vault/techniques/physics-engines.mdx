...
- **Core components:** [Collision detection](/vault/techniques/collision-detection), dynamics, constraint solving.
- **Major middleware:** [Havok](/vault/techniques/havok), PhysX, Bullet, Jolt, Box2D, Chipmunk.
- **Built-in:** [Unity](/vault/tools/unity) (PhysX-based + DOTS), [Unreal](/vault/games/unreal) (Chaos), Godot (Jolt), all modern engines.
