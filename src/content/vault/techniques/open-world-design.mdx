...
- **Pioneer:** *[Elite](/vault/games/elite)* ([Acornsoft](/vault/companies/acornsoft) / [David Braben](/vault/people/david-braben), [Ian Bell](/vault/people/ian-bell), 1984).
- **3D template:** *[Grand Theft Auto III](/vault/games/gta-iii)* (DMA / Rockstar, 2001).
- **Modern examples:** *Skyrim*, *Witcher 3*, *Breath of the Wild*, *Red Dead Redemption 2*, *Elden Ring*.
- **Common criticism:** "[Ubisoft](/vault/companies/ubisoft) towers", meaningless map markers, content-bloat without purpose.
