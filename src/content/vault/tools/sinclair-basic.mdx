...
This is stricter than C64 BASIC v2 (any name accepted; only first 2 characters significant) and visibly stricter than the BBC BASIC contemporary. These rules constrain what idiomatic Spectrum BASIC code can even look like.
...
1. **Type in listings from magazines.** First contact with the language. See [type-in programs](/vault/distribution/type-in-listings).
