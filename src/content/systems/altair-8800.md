...
storage: ["Paper tape", "Cassette tape", "Floppy disk (optional)"]
release_date:
  global: 1975-01-01
...
order: 1
external_links:
  - title: "Altair 8800 - Computer History Museum"
    url: "https://computerhistory.org/collections/altair-8800/"
  - title: "Altair Clone Project"
...
- **CPU**: Intel 8080 @ 2MHz
- **RAM**: 256 bytes base (expandable to 64 KB)
- **Storage**: None built-in (originally required paper tape or later cassette/floppy options)
