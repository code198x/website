...
concepts_introduced:
  - "Z80 loop patterns and techniques"
...
Complete **Pixel Painter** - your first creative assembly masterpiece! Apply everything you've learned to build a drawing program that showcases Z80 assembly programming and direct hardware control.
...
- Memory management for program data and artwork
...
```
**** PIXEL PAINTER v1.0 ****
Assembly Edition for ZX Spectrum
...
TOOLS: [B]rush [L]ine [C]olor [S]ave
       [P]attern [U]ndo [Q]uit [H]elp

Brush: ▓▓ (Block)  Color: BRIGHT 1
INK: 2 (Red)  PAPER: 7 (White)

Position: Row 12, Col 16
Press key to select tool...
```

Completing **Pixel Painter** in Z80 assembly proves you've mastered low-level programming and are ready for more advanced assembly challenges!