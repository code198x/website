...
import MemoryMapNES from '../../../../../components/MemoryMapNES.astro';
...
<MemoryMapNES 
  title="Nintendo Entertainment System Memory Map"
  highlightRegion="ram"
  activeAddress="$0000"
  showAddresses={true}
  showPPU={false}
...
**Understanding the NES Memory Architecture:**
- **Internal RAM** ($0000-$07FF) highlighted in green - includes zero page and stack
- **PPU Registers** ($2000-$2007) in blue - controls graphics and display
- **APU & I/O** ($4000-$4017) in purple - controls sound and input
- **Program ROM** ($8000-$FFFF) in red - contains game code and data
...
```assembly
; Demonstration of 6502 advanced addressing modes
