...
## Register Visualization: Game State Setup

Let's see how the 6502 registers look after setting up game variables:

import RegisterView6502 from '../../../../../components/RegisterView6502.astro';

<RegisterView6502 
  title="After Game State Initialization"
  registerA="80"
  registerX="00" 
  registerY="00"
  programCounter="8010"
...
**What happened in this game setup?**
- We loaded health value (5) and stored it to $0200
- We loaded X position (16) and stored it to $0201  
- We loaded Y position (128) and stored it to $0202
- The A register now contains the last value we loaded ($80 = 128)
- Memory locations $0200-$0202 now contain our game state!
