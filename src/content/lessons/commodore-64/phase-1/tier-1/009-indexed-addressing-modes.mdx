...
Understanding where screen memory lives in the C64's memory map helps you understand indexed addressing:

<MemoryMapC64 
  title="C64 Memory Map - Screen Memory Highlighted"
...
**What this shows:**
- **Screen RAM** ($0400-$07E7) is highlighted in yellow
- **Active address** ($0405) is marked with a red border - this is where our 'H' gets stored
- **Memory layout** shows how the 64KB address space is organized
- **Screen memory** is just 1KB (1000 bytes) for the 40×25 character display
