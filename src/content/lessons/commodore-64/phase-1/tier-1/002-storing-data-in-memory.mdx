...
<MemoryMapC64 
  title="C64 Memory Map - Zero Page and Screen Memory"
...
- **Zero Page** ($0000-$00FF) is highlighted in blue - the fastest memory for data storage
- **Screen RAM** ($0400-$07E7) is highlighted in yellow - where characters appear on screen
- **Active address** ($0400) shows the first screen position we're writing to
- **User RAM** areas in green show where you can store program data
