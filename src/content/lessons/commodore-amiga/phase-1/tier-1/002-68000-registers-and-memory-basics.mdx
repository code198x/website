...
<MemoryMapAmiga 
  title="Amiga Memory Map - 68000 Address Space"
  highlightRegion="chip"
  activeAddress="$000000"
  showAddresses={true}
  amigaModel="500"
/>

**Understanding the Amiga Memory Architecture:**
- **Chip RAM** ($000000-$07FFFF) highlighted in green - shared with custom chips for graphics/sound
- **Fast RAM** ($200000+) in blue - CPU-only memory for faster program execution
- **Custom Chips** ($C00000+) in red - Paula, Agnus, Denise hardware control registers
- **Kickstart ROM** ($F80000+) in dark red - contains the AmigaOS operating system
