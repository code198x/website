...
## Register Visualization: 68000 Register Power

Let's see the 68000's impressive register set in action:

import RegisterView68000 from '../../../../../components/RegisterView68000.astro';

<RegisterView68000 
  title="68000 Professional Register Set"
  dataRegisters={["12345678", "ABCD0000", "00000042", "00000000", "00000000", "00000000", "00000000", "00000000"]}
  addressRegisters={["000C0000", "00DFF000", "00080000", "00000000", "00000000", "00000000", "00000000", "00100000"]}
  programCounter="00080100"
  statusRegister="2000"
/>

**What we can see:**
- **D0**: Contains $12345678 - a full 32-bit value!
- **D1**: Contains $ABCD0000 - high word only
- **D2**: Contains $42 - single byte value
- **A0**: Points to $C0000 (graphics memory)
- **A1**: Points to $DFF000 (custom chip registers)
- **A7 (SP)**: Stack pointer at $100000

This shows the 68000's power - true 32-bit registers that can handle any size data!
