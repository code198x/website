...
**When to avoid:** A single sound effect — that's a [one-shot](/patterns/commodore-amiga/audio/one-shot-samples), not a sequencer.
...
Add those and the [one-shot interrupt](/patterns/commodore-amiga/audio/one-shot-samples) for one-shot instruments, and you have ProTracker.

## Related

**Patterns:** [One-Shot Samples](/patterns/commodore-amiga/audio/one-shot-samples), [Playing a Sample](/patterns/commodore-amiga/audio/playing-a-sample)
