...
related:
  patterns: ["vblank-game-loop", "copper-colour-bars"]
...
Sprite palettes are shared in pairs — sprite 0 and sprite 1 both draw from the same three colours. Use *attached* sprites to combine a pair into a single 15-colour sprite (see [Sprite Control Words](/patterns/commodore-amiga/assembly/rendering/sprite-control-words)).
...
**Patterns:** [Copper Colour Bars](/patterns/commodore-amiga/assembly/rendering/copper-colour-bars), [VBlank Game Loop](/patterns/commodore-amiga/assembly/framework/vblank-game-loop), [Sprite Control Words](/patterns/commodore-amiga/assembly/rendering/sprite-control-words)
