...
evolution:
  ...
  next: "blitter-line-draw"
related:
  patterns: ["blitter-copy", "blitter-line-draw", "sprite-control-words"]
...
| Limitation | Slower than a plain copy — four channels take 8 ticks a word against a copy's 4, so twice the time |
