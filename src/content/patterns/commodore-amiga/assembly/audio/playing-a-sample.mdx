...
Enable a channel and Paula plays `AUD0LC`/`AUD0LEN` and then **loops it forever** — perfect for a sustained instrument. To play a sound *once*, you catch Paula's channel interrupt after the first pass and repoint it at a silent word; see [One-Shot Samples](/patterns/commodore-amiga/assembly/audio/one-shot-samples).
