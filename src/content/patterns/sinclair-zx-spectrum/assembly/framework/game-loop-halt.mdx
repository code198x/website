...
**Vault:** [ULA](/vault/hardware/ula) — frame timing and memory contention | [Z80](/vault/hardware/z80) — HALT instruction | [ZX Spectrum](/vault/systems/sinclair-zx-spectrum)
