...
3. **Hide OAM sprites:** Cleared RAM means all 64 sprites have Y=0 — they'd pile up at the top of the screen as soon as rendering enables. Writing $FF to every Y position pushes them off-screen.
4. **Second wait:** PPU is now fully ready
...
**Patterns:** [NMI Game Loop](/patterns/nintendo-nes/assembly/framework/nmi-game-loop), [Palette Loading](/patterns/nintendo-nes/assembly/rendering/palette-loading)
