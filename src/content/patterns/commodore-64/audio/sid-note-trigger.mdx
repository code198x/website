...
**Evolution:** Note Trigger → [Envelope Shapes](/patterns/commodore-64/audio/sid-envelope-shapes) → [Music Driver](/patterns/commodore-64/audio/sid-music-driver)
