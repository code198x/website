...
**Patterns:** [Joystick Reading](/patterns/commodore-64/input/joystick-reading) | [Raster Interrupts](/patterns/commodore-64/framework/raster-interrupts)

**Vault:** [Inside the VIC-II](/vault/hardware/vic-ii) | [Commodore 64](/vault/systems/commodore-64)

**Evolution:** Basic → [IRQ-Driven](/patterns/commodore-64/framework/game-loop-irq) → [Double-Buffered](/patterns/commodore-64/framework/game-loop-double-buffered)
