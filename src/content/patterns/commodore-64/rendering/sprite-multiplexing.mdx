...
The VIC-II gives you [eight sprites](/patterns/commodore-64/rendering/hardware-sprites) — but only eight *at once on a given scanline*. The instant the raster beam passes the bottom of a sprite, that hardware sprite is idle and can be sent somewhere lower down the screen to appear as a completely different one. Trigger that with a [raster interrupt](/patterns/commodore-64/rendering/raster-splits), do it repeatedly, and eight sprites become sixteen, twenty-four, thirty — a *multiplexer*. It's how nearly every crowded C64 game put more than eight things on screen.
...
**Patterns:** [Hardware Sprites](/patterns/commodore-64/rendering/hardware-sprites), [Raster Splits](/patterns/commodore-64/rendering/raster-splits)
