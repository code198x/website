...
**When to avoid:** Large or numerous moving areas — past eight objects you must reuse sprites down the screen (see [Sprite Multiplexing](/patterns/commodore-64/assembly/rendering/sprite-multiplexing)), or draw into the bitmap instead.
...
**Patterns:** [Sprite Movement & Bounds](/patterns/commodore-64/assembly/physics/sprite-movement-bounds), [Game Loop (Basic)](/patterns/commodore-64/assembly/framework/game-loop-basic)
