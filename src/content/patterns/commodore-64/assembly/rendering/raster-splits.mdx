...
**When to avoid:** If a single static screen is all you need — the basic [game loop](/patterns/commodore-64/assembly/framework/game-loop-basic) polling `$D012` is simpler than wiring an interrupt.
...
**Patterns:** [Game Loop (Basic)](/patterns/commodore-64/assembly/framework/game-loop-basic), [Hardware Sprites](/patterns/commodore-64/assembly/rendering/hardware-sprites)
