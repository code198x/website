...
related:
  patterns: ["sid-note-trigger", "sid-multi-voice"]
...
**Patterns:** [SID Note Trigger](/patterns/commodore-64/assembly/audio/sid-note-trigger), [SID Multi-Voice](/patterns/commodore-64/assembly/audio/sid-multi-voice)
