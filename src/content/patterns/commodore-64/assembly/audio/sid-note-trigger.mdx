...
evolution:
  previous: null
  next: "sid-voice-setup"
related:
  patterns: ["sid-voice-setup"]
...
**Patterns:** [SID Voice Setup](/patterns/commodore-64/assembly/audio/sid-voice-setup), [SID Multi-Voice](/patterns/commodore-64/assembly/audio/sid-multi-voice)
