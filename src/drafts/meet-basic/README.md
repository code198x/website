...
Two lesson drafts for the agreed A1/A2 slice:
...
fresh-process loading, listing, running and a further edit. The four displayed
captures were inspected against those checkpoints. Specific Foundations links
...
continue Story Builder, and migrate the catalogues and affected links together.
These two drafts are not a replacement for all fifteen currently published units.
