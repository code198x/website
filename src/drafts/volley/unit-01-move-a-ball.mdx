...
Use keyword entry rather than spelling commands as letters. The listing includes the spacing supplied by the keyword tokens themselves.
Do not press Space again after entering a keyword. Preserve the space
