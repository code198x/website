...
system_tags: [C64]
tech_tags: ["Screen RAM", "VIC-II", "Memory map", "Direct screen access"]
years: [1982, 1994]
---
...
See [PETSCII Chart](/vault/petscii-chart) for complete conversion tables.
...
- [PETSCII Chart](/vault/petscii-chart) — character code reference
- [PRINT vs POKE](/vault/print-vs-poke) — performance comparison
- [VIC-II Chip](/vault/vic-ii-chip) — display hardware details
- [Commodore 64](/vault/commodore-64) — system overview
