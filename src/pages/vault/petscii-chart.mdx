...
system_tags: [C64]
tech_tags: ["PETSCII", "Character sets", "Screen codes", "CHR$"]
years: [1982, 1994]
---
...
- [Screen Memory](/vault/screen-memory) — layout and addressing
- [PRINT vs POKE](/vault/print-vs-poke) — performance comparison
- [VIC-II Chip](/vault/vic-ii-chip) — the hardware behind the display
- [Commodore 64](/vault/commodore-64) — the complete system
