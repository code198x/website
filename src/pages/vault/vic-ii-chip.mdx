...
system_tags: [C64]
tech_tags: ["VIC-II", "Hardware", "Registers", "Display modes"]
years: [1982, 1994]
---
...
- [Inside the VIC-II](/vault/vic-ii) — historical and cultural context
- [Screen Memory](/vault/screen-memory) — text display memory layout
- [Commodore 64](/vault/commodore-64) — complete system overview
- [Al Charpentier](/vault/al-charpentier) — chip designer
- [Raster Tricks 101](/vault/raster-tricks-101) — advanced techniques
