...
- [Gridlocked](/commodore-64/basic/week-2/lesson-09) — revisit the map lesson if you need a refresher.
- [Paradroid](/vault/paradroid) — study how grid logic powers classic C64 decks.
