...
prevLesson: "/commodore-64/assembly/game-01-starfield/unit-02"
nextLesson: "/commodore-64/assembly/game-01-starfield/unit-04"
...
Load `starfield.prg` in VICE. Move the ship with the joystick, then press fire. A small yellow bullet launches from the ship and flies upward until it disappears off the top of the screen.

## What's Changed

Unit 2's game loop read the joystick and moved the ship. This version adds three new sections to the loop:

1. **Check the fire button** — read bit 4 of `$DC00`
2. **Spawn a bullet** — if fire is pressed and no bullet is already active
3. **Update the bullet** — move it up each frame and deactivate it when it leaves the screen
...
<CodeFromFile src="commodore-64/game-01-starfield/unit-03/snippets/01-zero-page.asm" />
...
<CodeFromFile src="commodore-64/game-01-starfield/unit-03/snippets/02-fire-button.asm" />
...
<CodeFromFile src="commodore-64/game-01-starfield/unit-03/snippets/03-bullet-update.asm" />
...
<CodeFromFile src="commodore-64/game-01-starfield/unit-03/snippets/04-bullet-sprite.asm" />
...
<CodeFromFile src="commodore-64/game-01-starfield/unit-03/starfield.asm" />
...
<ImageComparison
  before="/images/commodore-64/game-01-starfield/unit-02/screenshot.png"
  after="/images/commodore-64/game-01-starfield/unit-03/screenshot.png"
