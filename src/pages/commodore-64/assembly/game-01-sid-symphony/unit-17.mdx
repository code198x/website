...
<VideoPlayer
  src="/videos/commodore-64/game-01-sid-symphony/unit-17/gameplay.mp4"
  caption="Song selection menu — choose which song to play"
  poster="/images/commodore-64/game-01-sid-symphony/unit-17/screenshot.png"
/>
...
<CodeDiff
  ...
  before="commodore-64/game-01-sid-symphony/unit-16/symphony.asm"
  after="commodore-64/game-01-sid-symphony/unit-17/symphony.asm"
  context={3}
/>
