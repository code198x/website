...
border_flash_timer: !byte 0   ; Frames remaining for border flash
miss_flash_timer:   !byte 0   ; Frames remaining for miss flash
```
...
;
; Adds visual feedback effects:
; - Cyan border flash when multiplier increases
; - Red border flash on miss
; - Effect timers for timed visual feedback
;==========================================================
