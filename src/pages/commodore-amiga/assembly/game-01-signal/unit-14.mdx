...
nextLesson: "/commodore-amiga/assembly/game-01-hop/unit-15"
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/01-difficulty-scaling-approach.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/02-calculating-level-speed.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/03-applying-speed-to-objects.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/04-adding-more-objects-on-higher-levels.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/05-adding-more-objects-on-higher-levels.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/06-simple-random-number-generator.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/07-displaying-the-level.asm" lang="asm" />

We'll add a 2-digit number drawing routine for cleaner display:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/08-displaying-the-level.asm" lang="asm" />

## Level Transition

When a level is completed (all homes filled), we already increment the level counter. Now we also activate new objects:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/snippets/09-level-transition.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-14/hop.asm" lang="asm" />
