...
nextLesson: "/commodore-amiga/assembly/game-01-hop/unit-06"
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-05/snippets/01-object-data-structures.asm" lang="asm" />

**Array of Structs** — each object is a contiguous block:
<CodeFromFile src="commodore-amiga/game-01-hop/unit-05/snippets/02-object-data-structures.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-05/snippets/03-the-car-structure.asm" lang="asm" />

## Initialising the Cars

We'll place cars in the four road lanes, alternating direction:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-05/snippets/04-initialising-the-cars.asm" lang="asm" />

## The Update Loop

Each frame, we loop through all cars:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-05/snippets/05-the-update-loop.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-05/snippets/06-wrapping-coordinates.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-05/snippets/07-signed-arithmetic.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-05/hop.asm" lang="asm" />
