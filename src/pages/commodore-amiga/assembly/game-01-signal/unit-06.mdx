...
nextLesson: "/commodore-amiga/assembly/game-01-hop/unit-07"
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/snippets/01-unified-object-system.asm" lang="asm" />

## Object Types

We'll define two types:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/snippets/02-object-types.asm" lang="asm" />

When drawing, we select the graphic and colour based on type:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/snippets/03-object-types.asm" lang="asm" />

## Log Graphics

Logs are wider than cars. We'll make them 32 pixels (2 words) wide:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/snippets/04-log-graphics.asm" lang="asm" />

Drawing a 2-word-wide object requires updating the blit size and modulo:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/snippets/05-log-graphics.asm" lang="asm" />

## Unified Object Data

Now we define all objects in one array:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/snippets/06-unified-object-data.asm" lang="asm" />

## Drawing with Variable Width

The blit width depends on object type:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/snippets/07-drawing-with-variable-width.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/snippets/08-colour-per-type.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-06/hop.asm" lang="asm" />
