...
nextLesson: "/commodore-amiga/assembly/game-01-hop/unit-04"
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/01-the-amiga-joystick.asm" lang="asm" />

But up/down require XOR decoding:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/02-the-amiga-joystick.asm" lang="asm" />

### The Fire Button

The joystick fire button is on CIA-A at $BFE001, bit 7 (active low):

<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/03-the-amiga-joystick.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/04-discrete-hopping.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/05-discrete-hopping.asm" lang="asm" />

## Sprite Position Variables

We'll track the frog's logical position in memory:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/06-sprite-position-variables.asm" lang="asm" />

### Movement Constants

Frogger movement is grid-based. We'll hop 16 pixels per move:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/07-sprite-position-variables.asm" lang="asm" />

### Boundaries

We need to keep the frog on screen:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/08-sprite-position-variables.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/09-updating-the-sprite-position.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/10-the-main-loop.asm" lang="asm" />

## The Joystick Routine

Here's the complete joystick reading with edge detection:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/snippets/11-the-joystick-routine.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-03/hop.asm" lang="asm" />
