...
nextLesson: "/commodore-amiga/assembly/game-01-hop/unit-12"
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/01-creating-simple-waveforms.asm" lang="asm" />

For a death sound, we might use noise or a descending tone:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/02-creating-simple-waveforms.asm" lang="asm" />

And a pleasant chime for reaching home:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/03-creating-simple-waveforms.asm" lang="asm" />

## Initialising Audio

Enable audio DMA in our startup code:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/04-initialising-audio.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/05-playing-a-sound.asm" lang="asm" />

## Convenience Routines

Create simple wrappers for each sound:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/06-convenience-routines.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/07-triggering-sounds.asm" lang="asm" />

In `kill_frog`:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/08-triggering-sounds.asm" lang="asm" />

In `fill_home_slot`:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/09-triggering-sounds.asm" lang="asm" />

## Paula Register Constants

Add these to your constants section:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/10-paula-register-constants.asm" lang="asm" />

## Sound Data in Chip RAM

Audio sample data MUST be in Chip RAM for Paula DMA to access it:

<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/snippets/11-sound-data-in-chip-ram.asm" lang="asm" />
...
<CodeFromFile src="commodore-amiga/game-01-hop/unit-11/hop.asm" lang="asm" />
