...
Prism.languages.z80 = {
  ...
  directive: {
    pattern:
      /\b(?:ORG|DEFB|DEFW|DEFS|EQU|INCLUDE|INCBIN|END|ALIGN|PHASE|DEPHASE|IF|ELSE|ENDIF|IFDEF|IFNDEF|MACRO|ENDM)\b/i,
    alias: "property",
  },
  string: /(["'`])(?:\\.|(?!\1)[^\\\r\n])*\1/,
  "op-code": {
  ...
  register: {
    pattern:
      /\b(?:A|B|C|D|E|F|H|L|AF|BC|DE|HL|SP|PC|IX|IY|IXH|IXL|IYH|IYL|a|b|c|d|e|f|h|l|af|bc|de|hl|sp|pc|ix|iy|ixh|ixl|iyh|iyl)\b/,
    alias: "variable",
  },
  "hex-number": {
