...
export const SYSTEM_COLORS: Record<string, SystemColor> = {
  'commodore-64': {
    ...
    palette: ['#000000', '#FFFFFF', '#883932', '#67B6BD', '#8B3F96', '#55A049', '#40318D', '#BFCD7A'],
  ...
  'zx-spectrum': {
    ...
    gradients: {
      ...
      subtle: 'linear-gradient(135deg, rgba(255, 0, 0, 0.2) 0%, rgba(0, 255, 0, 0.2) 50%, rgba(0, 0, 255, 0.2) 100%)'
    },
    palette: ['#000000', '#0000FF', '#FF0000', '#FF00FF', '#00FF00', '#00FFFF', '#FFFF00', '#FFFFFF'],
  ...
  'nintendo-entertainment-system': {
    ...
    palette: ['#7C7C7C', '#0000FC', '#0000BC', '#4428BC', '#940084', '#A80020', '#A81000', '#881400'],
  ...
  'atari-2600': {
    ...
    palette: ['#000000', '#404040', '#6C6C6C', '#909090', '#B0B0B0', '#C8C8C8', '#DCD0C0', '#FFFFFF'],
...
const ADDITIONAL_SYSTEMS = [
  'pet', 'amstrad-cpc', 'msx', 'game-boy', 'atari-st',
  'genesis', 'snes', 'jupiter-ace', 'bbc-micro'
];
