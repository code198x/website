...
export const VAULT_CATEGORIES = {
  applications: {
    ...
    infoDescription:
      "From music trackers to art packages, these applications defined what was possible for creative expression on classic computers. Each entry documents the technical innovations and creative workflows that made digital art and music creation accessible.",
    stats: [
  ...
  companies: {
    ...
    infoDescription:
      "From bedroom startups to corporate giants, these companies shaped the landscape of home computing. Each entry chronicles their contributions, key products, and lasting impact on the industry.",
    stats: [
  ...
  culture: {
    ...
    infoDescription:
      "Computing didn't happen in isolation. This collection documents the cultural movements, social phenomena, and community traditions that grew around classic computers and shaped how we think about technology today.",
    stats: [
  ...
  demos: {
    ...
    infoDescription:
      "Demos represent the purest form of technical artistry - code written not for utility but for beauty. This collection celebrates the productions that amazed audiences and pushed hardware far beyond what anyone thought possible.",
  },
  ...
  "development-tools": {
    ...
    infoDescription:
      "Before modern IDEs, developers crafted their programs with specialized tools. This collection documents the assemblers, debuggers, and development environments that made programming accessible on classic systems.",
  },
  ...
  emulators: {
    ...
    infoDescription:
      "When the original hardware becomes rare or fails, emulators keep the software alive. This collection honors the dedication of developers who reverse-engineered entire computer systems to preserve digital heritage.",
    stats: [
  ...
  events: {
    ...
    infoDescription:
      "From trade shows to demoparties, these events brought the computing community together, launched products, and created lasting memories. Each entry captures the atmosphere and significance of these milestone gatherings.",
  },
  ...
  formats: {
    ...
    infoDescription:
      "Behind every image, sound, or program was a file format. This collection documents the data structures that made digital content portable, explaining how technical constraints shaped creative possibilities.",
  },
  ...
  games: {
    ...
    infoDescription:
      "From groundbreaking technical achievements to pure gameplay innovation, these games represent the creativity and technical mastery of their era. Each entry includes historical context, technical details, and connections to the hardware and people that made them possible.",
    stats: [
  ...
  groups: {
    ...
    infoDescription:
      "Whether cracking software, creating demos, or developing games, groups amplified individual talent through collaboration. This collection chronicles the teams that achieved what no single person could accomplish alone.",
  },
  ...
  hardware: {
    ...
    infoDescription:
      "This collection documents the computers, consoles, chips, and peripherals that shaped the golden age of home computing. Each entry includes technical specifications, historical context, and connections to related software and techniques.",
    stats: [
  ...
  "operating-systems": {
    ...
    infoDescription:
      "Operating systems bridged the gap between raw hardware and user applications. This collection documents the system software that defined how millions of users interacted with their computers.",
  },
  ...
  people: {
    ...
    infoDescription:
      "Behind every innovation was a person with vision, determination, and skill. This collection celebrates the programmers, designers, entrepreneurs, and dreamers who built the foundation of our digital world.",
    stats: [
  ...
  "programming-languages": {
    ...
    infoDescription:
      "Each programming language represented a different philosophy about how humans should communicate with computers. This collection explores the languages that democratized programming and enabled new forms of creative expression.",
  },
  ...
  publications: {
    ...
    infoDescription:
      "Before the internet, knowledge spread through magazines, books, and newsletters. This collection honors the publications that educated a generation and preserved computing culture in print.",
    stats: [
  ...
  techniques: {
    ...
    infoDescription:
      "When hardware limitations seemed insurmountable, clever programmers found ways around them. This collection documents the programming techniques that made the impossible possible.",
    stats: [
  ...
  utilities: {
    ...
    infoDescription:
      "Utilities were the unsung heroes of classic computing - small programs that solved specific problems and made daily computer use more productive. This collection celebrates the tools that kept systems running smoothly.",
  },
};
